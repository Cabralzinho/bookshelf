...
export const AppBar = () => {
  return (
    <nav className="flex justify-center z-[999] fixed bottom-0 w-full">
      <ul className="flex items-center justify-around w-full max-w-[24rem] h-16 rounded-t-3xl bg-sky-700 shadow-md shadow-gray-400 dark:shadow-gray-800 overflow-hidden">
        {navItems.map((item) => (
          <NavLink
            key={item.name}
            id="appbar"
