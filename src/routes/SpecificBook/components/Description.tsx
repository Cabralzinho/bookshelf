    ...
    <div className="flex flex-col items-start gap-1 w-full">
      ...
      {isResumedDescription &&
        children.length > MAX_LETTERS_LENGTH_IN_RESUMED_DESCRIPTION && (
          <span className="hover:text-gray-500 cursor-pointer" onClick={() => setIsResumedDescription(false)}>
            Ver mais...
          </span>
        )}
      ...
      {!isResumedDescription &&
        children.length > MAX_LETTERS_LENGTH_IN_RESUMED_DESCRIPTION && (
          <span className="hover:text-gray-500 cursor-pointer" onClick={() => setIsResumedDescription(true)}>
            Ver menos...
          </span>
        )}
    </div>
